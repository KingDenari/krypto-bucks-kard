...
const Scanner: React.FC = () => {
  ...
  return (
    <div className="space-y-6 p-4 md:p-6">
      <div>
        <h1 className="text-2xl md:text-3xl font-bold mb-2">Barcode Scanner</h1>
        <p className="text-muted-foreground">
          Scan student cards to view balances and information.
        </p>
      </div>
          ...
          <CardContent>
            {student ? (
              <div className="space-y-4">
                <div className="bg-gradient-to-r from-black to-blue-600 p-4 md:p-6 rounded-lg text-white">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs md:text-sm text-white/70">{student.email}</p>
                  </div>
                </div>
              ...
              <div className="text-center py-8 text-muted-foreground">
                ...
                <p className="text-sm">Scan a student card to view their information</p>
              </div>
            )}
          </CardContent>
        </Card>
